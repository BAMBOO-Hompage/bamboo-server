...
import SMU.BAMBOO.Hompage.global.mail.service.MailFacade;
...
public class MailController {
    ...
    public SuccessResponse<String> sendVerificationCode(String email) {
        ...
        mailFacade.sendVerificationEmail(email);
    ...
    public SuccessResponse<EmailVerificationResponse> verifyEmail(VerifyEmailDto request) {
        ...
        EmailVerificationResponse result = mailFacade.verifyAuthCode(request.email(), request.authcode());
